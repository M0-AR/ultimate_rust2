...
//! for cultivars of Cucurbita pepo, but some cultivars of Cucurbita maxima, C. argyrosperma, 
//! and C. moschata with similar appearance are also sometimes called "pumpkins".
//! 
...
// By running `cargo doc --no-deps --open --document-private-items` 
