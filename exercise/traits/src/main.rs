...
fn main() {
    ...
    match cake {
        ...
        Cake::Caramel => println!("Dreams do come true!"),
    ...
    // 4. You prefer  Caramel cake. Use "struct update syntax" to create a Dessert with `cake`
    // set to `Cake::Caramel`, but the rest of the values are default.
    //
